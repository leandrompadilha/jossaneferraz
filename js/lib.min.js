!function(e, t, n) {
    ...
    function a() {
        var e = t.body;
        return e || (e = r(p ? "svg" : "body"),
        e.fake = !0),
        e
    }
    function s(e, n, i, s) {
        var o, l, u, c, p = "modernizr", h = r("div"), f = a();
        if (parseInt(i, 10))
            for (; i--; )
                u = r("div"),
                u.id = s ? s[i] : p + (i + 1),
        ...
        d.style.overflow = c,
        d.offsetHeight) : h.parentNode.removeChild(h),
        !!l
    }
    var o = []
      , l = {
      ...
      , u = function() {};
    u.prototype = l,
    (u = new u).addTest("history", function() {
        var t = navigator.userAgent;
        return (-1 === t.indexOf("Android 2.") && -1 === t.indexOf("Android 4.0") || -1 === t.indexOf("Mobile Safari") || -1 !== t.indexOf("Chrome") || -1 !== t.indexOf("Windows Phone") || "file:" === location.protocol) && (e.history && "pushState"in e.history)
    }),
    u.addTest("picture", "HTMLPictureElement"in e),
    ...
    l.mq = h,
    u.addTest("mediaqueries", h("only all")),
    function() {
        var e, t, n, r, a, s, l;
        for (var d in o)
            if (o.hasOwnProperty(d)) {
                if (e = [],
                (t = o[d]).name && (e.push(t.name.toLowerCase()),
                ...
                a = 0; a < e.length; a++)
                    s = e[a],
                    1 === (l = s.split(".")).length ? u[l[0]] = r : (!u[l[0]] || u[l[0]]instanceof Boolean || (u[l[0]] = new Boolean(u[l[0]])),
                    u[l[0]][l[1]] = r),
                    c.push((r ? "" : "no-") + l.join("-"))
            }
    }(),
...
function(e, t) {
    ...
    function a(e, t, n) {
        ...
        }) : Ce.test(t) ? fe.filter(t, e, n) : (t = fe.filter(t, e),
    ...
    function v(e, t, n, i) {
        ...
        , l = o(), u = n && n[3] || (fe.cssNumber[t] ? "" : "px"), c = (fe.cssNumber[t] || "px" !== u && +l) && Fe.exec(fe.css(e, t));
        if (c && c[3] !== u) {
            u = u || c[3],
            n = n || [],
            c = +l || 1;
    ...
    function m(e) {
        var t, n = e.ownerDocument, i = e.nodeName, r = Re[i];
    ...
    function g(e, t) {
        for (var n, i, r = [], a = 0, s = e.length; a < s; a++)
            ...
            t ? ("none" === n && (r[a] = ze.get(i, "display") || null,
            r[a] || (i.style.display = "")),
            "" === i.style.display && Be(i) && (r[a] = m(i))) : "none" !== n && (r[a] = "none",
            ze.set(i, "display", n)));
        for (a = 0; a < s; a++)
    ...
    function w(e, t, n, i, r) {
        for (var a, s, o, l, u, c, d = t.createDocumentFragment(), p = [], h = 0, f = e.length; h < f; h++)
            if ((a = e[h]) || 0 === a)
                if ("object" === fe.type(a))
                    fe.merge(p, a.nodeType ? [a] : a);
                else if (Ge.test(a)) {
                    for (s = s || d.appendChild(t.createElement("div")),
                    o = (We.exec(a) || ["", ""])[1].toLowerCase(),
                    l = Ye[o] || Ye._default,
                    s.innerHTML = l[1] + fe.htmlPrefilter(a) + l[2],
                    c = l[0]; c--; )
                        s = s.lastChild;
        ...
        h = 0; a = p[h++]; )
            if (i && fe.inArray(a, i) > -1)
                r && r.push(a);
            else if (u = fe.contains(a.ownerDocument, a),
            s = y(d.appendChild(a), "script"),
            u && b(s),
            n)
                for (c = 0; a = s[c++]; )
        ...
        if (1 === t.nodeType) {
            ...
            u = a.events)) {
                ...
                for (r in u)
                    for (n = 0,
                    i = u[r].length; n < i; n++)
                        fe.event.add(t, r, u[r][n])
            }
            Ne.hasData(e) && (o = Ne.access(e),
            l = fe.extend({}, o),
            Ne.set(t, l))
        }
    }
    ...
    function P(e, t, i, r) {
        t = re.apply([], t);
        var a, s, o, l, u, c, d = 0, p = e.length, h = p - 1, f = t[0], v = fe.isFunction(f);
        if (v || p > 1 && "string" == typeof f && !pe.checkClone && tt.test(f))
            return e.each(function(n) {
                var a = e.eq(n);
                v && (t[0] = f.call(this, n, a.html())),
                P(a, t, i, r)
            });
        if (p && (a = w(t, e[0].ownerDocument, !1, e, r),
        s = a.firstChild,
        1 === a.childNodes.length && (a = s),
        s || r)) {
            for (l = (o = fe.map(y(a, "script"), k)).length; d < p; d++)
                u = a,
                d !== h && (u = fe.clone(u, !0, !0),
                l && fe.merge(o, y(u, "script"))),
                i.call(e[d], u, d);
            if (l)
                ...
                d = 0; d < l; d++)
                    u = o[d],
                    Xe.test(u.type || "") && !ze.access(u, "globalEval") && fe.contains(c, u) && (u.src ? fe._evalUrl && fe._evalUrl(u.src) : n(u.textContent.replace(it, ""), c))
        }
        return e
    }
    function D(e, t, n) {
        for (var i, r = t ? fe.filter(t, e) : e, a = 0; null != (i = r[a]); a++)
            n || 1 !== i.nodeType || fe.cleanData(y(i)),
            i.parentNode && (n && fe.contains(i.ownerDocument, i) && b(y(i, "script")),
    ...
    function O(e, t, n) {
        ...
        !pe.pixelMarginRight() && at.test(s) && rt.test(t) && (i = o.width,
        r = o.minWidth,
        a = o.maxWidth,
    ...
    function N(e) {
        var t = fe.cssProps[e];
        return t || (t = fe.cssProps[e] = z(e) || e),
        t
    }
    function $(e, t, n) {
        var i = Fe.exec(t);
    ...
    function H(e, t, n, i, r) {
        var a, s = 0;
        for (a = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; a < 4; a += 2)
            "margin" === n && (s += fe.css(e, n + qe[a], !0, r)),
            i ? ("content" === n && (s -= fe.css(e, "padding" + qe[a], !0, r)),
            "margin" !== n && (s -= fe.css(e, "border" + qe[a] + "Width", !0, r))) : (s += fe.css(e, "padding" + qe[a], !0, r),
            "padding" !== n && (s += fe.css(e, "border" + qe[a] + "Width", !0, r)));
        return s
    }
    function j(e, t, n) {
        var i, r = st(e), a = O(e, t, r), s = "border-box" === fe.css(e, "boxSizing", !1, r);
        return at.test(a) ? a : (i = s && (pe.boxSizingReliable() || a === e.style[t]),
        "auto" === a && (a = e["offset" + t[0].toUpperCase() + t.slice(1)]),
        (a = parseFloat(a) || 0) + H(e, t, n || (s ? "border" : "content"), i, r) + "px")
    }
    function F(e, t, n, i, r) {
        return new F.prototype.init(e,t,n,i,r)
    }
    function q() {
        ft && (!1 === te.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(q) : e.setTimeout(q, fe.fx.interval),
        fe.fx.tick())
    }
    function B() {
    ...
    function W(e, t, n) {
        var i, r, a = 0, s = W.prefilters.length, o = fe.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (r)
                return !1;
            for (var t = ht || B(), n = Math.max(0, u.startTime + u.duration - t), i = 1 - (n / u.duration || 0), a = 0, s = u.tweens.length; a < s; a++)
                u.tweens[a].run(i);
            return o.notifyWith(e, [u, i, n]),
            i < 1 && s ? n : (s || o.notifyWith(e, [u, 1, 0]),
            o.resolveWith(e, [u]),
            !1)
        }, u = o.promise({
            elem: e,
        ...
        for (_(c, u.opts.specialEasing); a < s; a++)
            if (i = W.prefilters[a].call(u, e, c, u.opts))
                return fe.isFunction(i.stop) && (fe._queueHooks(u.elem, u.opts.queue).stop = fe.proxy(i.stop, i)),
                i;
        return fe.map(c, R, u),
    ...
    function U(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, r = 0, a = t.toLowerCase().match(Le) || [];
            if (fe.isFunction(n))
                for (; i = a[r++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function Q(e, t, n, i) {
        function r(o) {
            var l;
            return a[o] = !0,
            fe.each(e[o] || [], function(e, o) {
                var u = o(t, n, i);
                return "string" != typeof u || s || a[u] ? s ? !(l = u) : void 0 : (t.dataTypes.unshift(u),
                r(u),
                !1)
            }),
            l
    ...
    function Z(e, t, n, i) {
        var r, a, s, o, l, u = {}, c = e.dataTypes.slice();
        if (c[1])
        ...
        o--); o < l; o++)
            if (null != (e = arguments[o]))
                for (t in e)
                    n = s[t],
                    i = e[t],
                    s !== i && (u && i && (fe.isPlainObject(i) || (r = Array.isArray(i))) ? (r ? (r = !1,
                    a = n && Array.isArray(n) ? n : []) : a = n && fe.isPlainObject(n) ? n : {},
                    s[t] = fe.extend(u, a, i)) : void 0 !== i && (s[t] = i));
        return s
    }
    ,
    fe.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (i(Object(e)) ? fe.merge(n, "string" == typeof e ? [e] : e) : ae.call(n, e)),
            n
        },
    ...
    var be = function(e) {
        function t(e, t, n, i) {
            var r, a, s, o, l, c, p, h = t && t.ownerDocument, f = t ? t.nodeType : 9;
            if (n = n || [],
            "string" != typeof e || !e || 1 !== f && 9 !== f && 11 !== f)
                return n;
            if (!i && ((t ? t.ownerDocument || t : F) !== D && P(t),
            t = t || D,
            A)) {
                if (11 !== f && (l = ve.exec(e)))
                    if (r = l[1]) {
                ...
                if (w.qsa && !_[e + " "] && (!z || !z.test(e))) {
                    if (1 !== f)
                        ...
                        for ((o = t.getAttribute("id")) ? o = o.replace(be, we) : t.setAttribute("id", o = j),
                        a = (c = C(e)).length; a--; )
                            c[a] = "#" + o + " " + d(c[a]);
                        p = c.join(","),
        ...
        function m(e, t, n, r, a, s) {
            ...
            a && !a[j] && (a = m(a, s)),
            i(function(i, s, o, l) {
                var u, c, d, p = [], h = [], m = s.length, g = i || f(t || "*", o.nodeType ? [o] : o, []), y = !e || !i && t ? g : v(g, p, e, o, l), b = n ? a || (i ? e : m || r) ? [] : s : y;
                if (n && n(y, b, o, l),
                r)
                    for (u = v(b, h),
                    r(u, [], o, l),
                ...
                if (i) {
                    if (a || e) {
                        ...
                        for (c = b.length; c--; )
                            (d = b[c]) && (u = a ? J(i, d) : p[c]) > -1 && (i[u] = !(s[u] = d))
                    }
                } else
                    b = v(b === s ? b.splice(m, b.length) : b),
                    a ? a(null, s, b, l) : Q.apply(s, b)
            })
        }
        function g(e) {
        ...
        function y(e, n) {
            var r = n.length > 0
              ...
              , s = function(i, s, o, l, u) {
                var c, d, p, h = 0, f = "0", m = i && [], g = [], y = M, b = i || a && x.find.TAG("*", u), w = q += null == y ? 1 : Math.random() || .1, T = b.length;
        ...
        var b, w, x, T, E, C, S, k, M, I, L, P, D, O, A, z, N, $, H, j = "sizzle" + 1 * new Date, F = e.document, q = 0, B = 0, V = n(), R = n(), _ = n(), W = function(e, t) {
            return e === t && (L = !0),
            0
        }, X = {}.hasOwnProperty, Y = [], G = Y.pop, U = Y.push, Q = Y.push, K = Y.slice, J = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, Z = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ee = "[\\x20\\t\\r\\n\\f]", te = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", ne = "\\[" + ee + "*(" + te + ")(?:" + ee + "*([*^$|!~]?=)" + ee + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + te + "))|)" + ee + "*\\]", ie = ":(" + te + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + ne + ")*)|.*)\\)|)", re = new RegExp(ee + "+","g"), ae = new RegExp("^" + ee + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ee + "+$","g"), se = new RegExp("^" + ee + "*," + ee + "*"), oe = new RegExp("^" + ee + "*([>+~]|" + ee + ")" + ee + "*"), le = new RegExp("=" + ee + "*([^\\]'\"]*?)" + ee + "*\\]","g"), ue = new RegExp(ie), ce = new RegExp("^" + te + "$"), de = {
            ID: new RegExp("^#(" + te + ")"),
            CLASS: new RegExp("^\\.(" + te + ")"),
            TAG: new RegExp("^(" + te + "|[*])"),
            ATTR: new RegExp("^" + ne),
        ...
        }, pe = /^(?:input|select|textarea|button)$/i, he = /^h\d$/i, fe = /^[^{]+\{\s*\[native \w/, ve = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, me = /[+~]/, ge = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)","ig"), ye = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        P = t.setDocument = function(e) {
            ...
            O = D.documentElement,
            A = !E(D),
            F !== D && (n = D.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)),
            ...
            w.getById = r(function(e) {
                ...
                !D.getElementsByName || !D.getElementsByName(j).length
            }),
            ...
            (w.qsa = fe.test(D.querySelectorAll)) && (r(function(e) {
                ...
                e.querySelectorAll("[selected]").length || z.push("\\[" + ee + "*(?:value|" + Z + ")"),
                e.querySelectorAll("[id~=" + j + "-]").length || z.push("~="),
                e.querySelectorAll(":checked").length || z.push(":checked"),
                e.querySelectorAll("a#" + j + "+*").length || z.push(".#.+[+~]")
            }),
            r(function(e) {
            ...
            (w.matchesSelector = fe.test($ = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && r(function(e) {
                w.disconnectedMatch = $.call(e, "*"),
                $.call(e, "[s!='']:x"),
                N.push("!=", ie)
            }),
            z = z.length && new RegExp(z.join("|")),
            N = N.length && new RegExp(N.join("|")),
            t = fe.test(O.compareDocumentPosition),
            H = t || fe.test(O.contains) ? function(e, t) {
            ...
            : function(e, t) {
                if (e === t)
                    return L = !0,
                    0;
                var n, i = 0, r = e.parentNode, a = t.parentNode, o = [e], l = [t];
                if (!r || !a)
                    return e === D ? -1 : t === D ? 1 : r ? -1 : a ? 1 : I ? J(I, e) - J(I, t) : 0;
                if (r === a)
                    return s(e, t);
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(le, "='$1']"),
            w.matchesSelector && A && !_[n + " "] && (!N || !N.test(n)) && (!z || !z.test(n)))
                try {
                    var i = $.call(e, n);
        ...
        (x = t.selectors = {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, r) {
                    ...
                    : function(t, n, l) {
                        var u, c, d, p, h, f, v = a !== s ? "nextSibling" : "previousSibling", m = t.parentNode, g = o && t.nodeName.toLowerCase(), y = !l && !o, b = !1;
                        if (m) {
                            if (a) {
                                for (; v; ) {
                                    for (p = t; p = p[v]; )
                            ...
                            s && y) {
                                for (b = (h = (u = (c = (d = (p = m)[j] || (p[j] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === q && u[1]) && u[2],
                                p = h && m.childNodes[h]; p = ++h && p && p[v] || (b = h = 0) || f.pop(); )
                            ...
                            b = h),
                            !1 === b)
                                for (; (p = ++h && p && p[v] || (b = h = 0) || f.pop()) && ((o ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++b || (y && (d = p[j] || (p[j] = {}),
                                c = d[p.uniqueID] || (d[p.uniqueID] = {}),
                                c[e] = [q, b]),
                                p !== t)); )
                                    ;
                ...
                PSEUDO: function(e, n) {
                    ...
                    return a[j] ? a(n) : a.length > 1 ? (r = [e, e, "", n],
        ...
        C = t.tokenize = function(e, n) {
            ...
            l = [],
            u = x.preFilter; o; ) {
                i && !(r = se.exec(o)) || (r && (o = o.slice(r[0].length) || o),
                l.push(a = [])),
                i = !1,
                (r = oe.exec(o)) && (i = r.shift(),
                a.push({
                    value: i,
                    type: r[0].replace(ae, " ")
                }),
                o = o.slice(i.length));
                for (s in x.filter)
                    !(r = de[s].exec(o)) || u[s] && !(r = u[s](r)) || (i = r.shift(),
                    a.push({
                        value: i,
                        type: s,
                        matches: r
        ...
        k = t.select = function(e, t, n, i) {
            var r, a, s, o, l, c = "function" == typeof e && e, p = !i && C(e = c.selector || e);
            if (n = n || [],
            1 === p.length) {
                if ((a = p[0] = p[0].slice(0)).length > 2 && "ID" === (s = a[0]).type && 9 === t.nodeType && A && x.relative[a[1].type]) {
                    if (!(t = (x.find.ID(s.matches[0].replace(ge, ye), t) || [])[0]))
                        return n;
                    c && (t = t.parentNode),
                    e = e.slice(a.shift().value.length)
                }
                for (r = de.needsContext.test(e) ? 0 : a.length; r-- && (s = a[r],
                !x.relative[o = s.type]); )
            ...
            return (c || S(e, p))(i, t, !A, n, !t || me.test(e) && u(t.parentNode) || t),
            n
        }
        ,
    ...
    (fe.fn.init = function(e, t, n) {
        ...
        if (n = n || Se,
        "string" == typeof e) {
            if (!(i = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : ke.exec(e)) || !i[1] && t)
                return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (i[1]) {
                if (t = t instanceof fe ? t[0] : t,
                fe.merge(this, fe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : te, !0)),
                Ee.test(i[1]) && fe.isPlainObject(t))
                    for (i in t)
    ...
    fe.fn.extend({
        ...
        closest: function(e, t) {
            var n, i = 0, r = this.length, a = [], s = "string" != typeof e && fe(e);
            if (!Te.test(e))
                for (; i < r; i++)
    ...
    fe.each({
        ...
        fe.fn[e] = function(n, i) {
            ...
            i && "string" == typeof i && (r = fe.filter(i, r)),
            this.length > 1 && (Ie[e] || fe.uniqueSort(r),
            Me.test(e) && r.reverse()),
            this.pushStack(r)
        }
    });
    ...
    fe.extend({
              ...
              , r = {
                ...
                then: function(t, i, r) {
                        ...
                        return function() {
                            var o = this
                              ...
                              , d = function() {
                                var e, d;
                                if (!(t < s)) {
                                    if ((e = i.apply(o, c)) === n.promise())
                                        throw new TypeError("Thenable self-resolution");
                                    d = e && ("object" == typeof e || "function" == typeof e) && e.then,
                                    fe.isFunction(d) ? r ? d.call(e, a(s, n, l, r), a(s, n, u, r)) : (s++,
                                    d.call(e, a(s, n, l, r), a(s, n, u, r), a(s, n, l, n.notifyWith))) : (i !== l && (o = void 0,
                                    c = [e]),
                                    (r || n.resolveWith)(o, c))
                                }
                            }
                    ...
                    return fe.Deferred(function(e) {
                        n[0][3].add(a(0, e, fe.isFunction(r) ? r : l, e.notifyWith)),
                        n[1][3].add(a(0, e, fe.isFunction(t) ? t : l)),
                        n[2][3].add(a(0, e, fe.isFunction(i) ? i : u))
                    }).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            if (t <= 1 && (c(e, a.done(s(n)).resolve, a.reject, !t),
            "pending" === a.state() || fe.isFunction(r[n] && r[n].then)))
                return a.then();
            for (; n--; )
                c(r[n], s(n), a.reject);
            return a.promise()
    ...
    fe.extend({
        ...
        ready: function(e) {
            ...
            !0 !== e && --fe.readyWait > 0 || De.resolveWith(te, [fe]))
        }
    }),
    fe.ready.then = De.then,
    "complete" === te.readyState || "loading" !== te.readyState && !te.documentElement.doScroll ? e.setTimeout(fe.ready) : (te.addEventListener("DOMContentLoaded", d),
    ...
    fe.fn.extend({
        data: function(e, t) {
            ...
            if (void 0 === e) {
                if (this.length && (r = Ne.get(a),
                1 === a.nodeType && !ze.get(a, "hasDataAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = fe.camelCase(i.slice(5)),
                        f(a, i, r[i]));
    ...
    fe.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = ze.get(e, t),
                n && (!i || Array.isArray(n) ? i = ze.access(e, t, fe.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    fe.fn.extend({
        ...
        promise: function(e, t) {
            var n, i = 1, r = fe.Deferred(), a = this, s = this.length, o = function() {
                --i || r.resolveWith(a, [a])
            };
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; s--; )
                (n = ze.get(a[s], e + "queueHooks")) && n.empty && (i++,
                n.empty.add(o));
            return o(),
            r.promise(t)
        }
    ...
    fe.event = {
        ...
        add: function(e, t, n, i, r) {
            ...
            if (m)
                ...
                n = a.handler,
                r = a.selector),
                r && fe.find.matchesSelector(Ue, r),
            ...
            if (m && (l = m.events)) {
                for (u = (t = (t || "").match(Le) || [""]).length; u--; )
                    ...
                    h) {
                        ...
                        s = a = p.length; a--; )
                            c = p[a],
                            !r && v !== c.origType || n && n.guid !== c.guid || o && !o.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(a, 1),
                            c.selector && p.delegateCount--,
                            d.remove && d.remove.call(e, c));
                        s && !p.length && (d.teardown && !1 !== d.teardown.call(e, f, m.handle) || fe.removeEvent(e, h, m.handle),
                        delete l[h])
                    } else
                        for (h in l)
                            fe.event.remove(e, h + t[u], n, i, !0);
                fe.isEmptyObject(l) && ze.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, r, a, s, o = fe.event.fix(e), l = new Array(arguments.length), u = (ze.get(this, "events") || {})[o.type] || [], c = fe.event.special[o.type] || {};
            for (l[0] = o,
            t = 1; t < arguments.length; t++)
                l[t] = arguments[t];
            if (o.delegateTarget = this,
            !c.preDispatch || !1 !== c.preDispatch.call(this, o)) {
                for (s = fe.event.handlers.call(this, o, u),
                t = 0; (r = s[t++]) && !o.isPropagationStopped(); )
                    ...
                    n = 0; (a = r.handlers[n++]) && !o.isImmediatePropagationStopped(); )
                        ...
                        o.data = a.data,
                        void 0 !== (i = ((fe.event.special[a.origType] || {}).handle || a.handler).apply(r.elem, l)) && !1 === (o.result = i) && (o.preventDefault(),
                        o.stopPropagation()));
                ...
                for (; u !== this; u = u.parentNode || this)
                    if (1 === u.nodeType && ("click" !== e.type || !0 !== u.disabled)) {
                        ...
                        n = 0; n < l; n++)
                            i = t[n],
                            r = i.selector + " ",
                            void 0 === s[r] && (s[r] = i.needsContext ? fe(r, this).index(u) > -1 : fe.find(r, this, null, [u]).length),
                            s[r] && a.push(i);
                        a.length && o.push({
                            elem: u,
                            handlers: a
    ...
    fe.each({
        ...
        fe.event.special[e] = {
            ...
            handle: function(e) {
                ...
                return r && (r === i || fe.contains(i, r)) || (e.type = a.origType,
    ...
    fe.extend({
        ...
        clone: function(e, t, n) {
            var i, r, a, s, o = e.cloneNode(!0), l = fe.contains(e.ownerDocument, e);
            ...
            if (t)
                if (n)
                    ...
                    I(e, o);
            return (s = y(o, "script")).length > 0 && b(s, !l && y(e, "script")),
            o
        },
    ...
    fe.each({
        ...
        fe.fn[e] = function(e) {
            for (var n, i = [], r = fe(e), a = r.length - 1, s = 0; s <= a; s++)
    ...
    !function() {
        ...
        var n, i, r, a, s = te.createElement("div"), o = te.createElement("div");
        o.style && (o.style.backgroundClip = "content-box",
        o.cloneNode(!0).style.backgroundClip = "",
        pe.clearCloneStyle = "content-box" === o.style.backgroundClip,
    ...
    fe.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, a, s, o = fe.camelCase(t), l = lt.test(t), u = e.style;
                return l || (t = N(o)),
                s = fe.cssHooks[t] || fe.cssHooks[o],
                void 0 === n ? s && "get"in s && void 0 !== (r = s.get(e, !1, i)) ? r : u[t] : ("string" === (a = typeof n) && (r = Fe.exec(n)) && r[1] && (n = v(e, t, r),
                a = "number"),
                void (null != n && n === n && ("number" === a && (n += r && r[3] || (fe.cssNumber[o] ? "" : "px")),
        ...
        css: function(e, t, n, i) {
            ...
            return lt.test(t) || (t = N(o)),
            (s = fe.cssHooks[t] || fe.cssHooks[o]) && "get"in s && (r = s.get(e, !0, n)),
            void 0 === r && (r = O(e, t, i)),
    ...
    fe.each(["height", "width"], function(e, t) {
        fe.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !ot.test(fe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? j(e, t, i) : Ve(e, ut, function() {
                        return j(e, t, i)
                    })
            },
            set: function(e, n, i) {
                var r, a = i && st(e), s = i && H(e, t, i, "border-box" === fe.css(e, "boxSizing", !1, a), a);
                return s && (r = Fe.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n,
                n = fe.css(e, t)),
                $(0, n, s)
            }
        }
    ...
    fe.cssHooks.marginLeft = A(pe.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(O(e, "marginLeft")) || e.getBoundingClientRect().left - Ve(e, {
                marginLeft: 0
            }, function() {
    ...
    fe.fx = F.prototype.init,
    fe.fx.step = {};
    var ht, ft, vt = /^(?:toggle|show|hide)$/, mt = /queueHooks$/;
    fe.Animation = fe.extend(W, {
        tweeners: {
            "*": [function(e, t) {
                var n = this.createTween(e, t);
                return v(n.elem, e, Fe.exec(t), n),
                n
            }
            ]
        },
        ...
        prefilters: [function(e, t, n) {
            var i, r, a, s, o, l, u, c, d = "width"in t || "height"in t, p = this, h = {}, f = e.style, v = e.nodeType && Be(e), m = ze.get(e, "fxshow");
            ...
            if ((l = !fe.isEmptyObject(t)) || !fe.isEmptyObject(h)) {
                d && 1 === e.nodeType && (n.overflow = [f.overflow, f.overflowX, f.overflowY],
                null == (u = m && m.display) && (u = ze.get(e, "display")),
                "none" === (c = fe.css(e, "display")) && (u ? c = u : (g([e], !0),
                u = e.style.display || u,
                c = fe.css(e, "display"),
                g([e]))),
                ...
                l = !1;
                for (i in h)
                    l || (m ? "hidden"in m && (v = m.hidden) : m = ze.access(e, "fxshow", {
                        display: u
                    }),
                    a && (m.hidden = !v),
                    v && g([e], !0),
    ...
    fe.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each(function() {
                var t, n = ze.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], a = fe.timers, s = i ? i.length : 0;
                for (n.finish = !0,
                fe.queue(this, e, []),
    ...
    fe.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== a && 8 !== a && 2 !== a)
                return void 0 === e.getAttribute ? fe.prop(e, t, n) : (1 === a && fe.isXMLDoc(e) || (r = fe.attrHooks[t.toLowerCase()] || (fe.expr.match.bool.test(t) ? gt : void 0)),
                void 0 !== n ? null === n ? void fe.removeAttr(e, t) : r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
                n) : r && "get"in r && null !== (i = r.get(e, t)) ? i : null == (i = fe.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : fe.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    ...
                    void 0 !== e && "boolean" !== n || ((t = Y(this)) && ze.set(this, "__className__", t),
    ...
    fe.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    var t, n, i, a = e.options, s = e.selectedIndex, o = "select-one" === e.type, l = o ? null : [], u = o ? s + 1 : a.length;
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, a = fe.makeArray(t), s = r.length; s--; )
                        i = r[s],
                        (i.selected = fe.inArray(fe.valHooks.option.get(i), a) > -1) && (n = !0);
    ...
    fe.extend(fe.event, {
        trigger: function(t, n, i, r) {
            var a, s, o, l, u, c, d, p = [i || te], h = ue.call(t, "type") ? t.type : t, f = ue.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = o = i = i || te,
            3 !== i.nodeType && 8 !== i.nodeType && !Tt.test(h + fe.event.triggered) && (h.indexOf(".") > -1 && (f = h.split("."),
            h = f.shift(),
            f.sort()),
            u = h.indexOf(":") < 0 && "on" + h,
            ...
            r || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!r && !d.noBubble && !fe.isWindow(i)) {
                    ...
                    Tt.test(l + h) || (s = s.parentNode); s; s = s.parentNode)
                        p.push(s),
                        o = s;
                ...
                for (a = 0; (s = p[a++]) && !t.isPropagationStopped(); )
                    ...
                    (c = (ze.get(s, "events") || {})[t.type] && ze.get(s, "handle")) && c.apply(s, n),
                    (c = u && s[u]) && c.apply && Ae(s) && (t.result = c.apply(s, n),
                    !1 === t.result && t.preventDefault());
                return t.type = h,
                r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), n) || !Ae(i) || u && fe.isFunction(i[h]) && !fe.isWindow(i) && ((o = i[u]) && (i[u] = null),
    ...
    pe.focusin || fe.each({
        ...
        fe.event.special[t] = {
            ...
            teardown: function() {
                var i = this.ownerDocument || this
                  , r = ze.access(i, t) - 1;
                r ? ze.access(i, t, r) : (i.removeEventListener(e, n, !0),
                ze.remove(i, t))
            }
        }
    });
    ...
    fe.extend({
        ...
        ajax: function(t, n) {
            function i(t, n, i, o) {
                ...
                i && (w = J(f, E, i)),
                w = Z(f, w, E, u),
                u ? (f.ifModified && ((x = E.getResponseHeader("Last-Modified")) && (fe.lastModified[a] = x),
                (x = E.getResponseHeader("etag")) && (fe.etag[a] = x)),
                ...
                E.status = t,
                E.statusText = (n || T) + "",
                u ? g.resolveWith(v, [p, T, E]) : g.rejectWith(v, [E, T, h]),
                E.statusCode(b),
                b = void 0,
                d && m.trigger(u ? "ajaxSuccess" : "ajaxError", [E, f, u ? p : h]),
                y.fireWith(v, [E, T]),
                d && (m.trigger("ajaxComplete", [E, f]),
                --fe.active || fe.event.trigger("ajaxStop")))
            }
            "object" == typeof t && (n = t,
            t = void 0),
            n = n || {};
            var r, a, s, o, l, u, c, d, p, h, f = fe.ajaxSetup({}, n), v = f.context || f, m = f.context && (v.nodeType || v.jquery) ? fe(v) : fe.event, g = fe.Deferred(), y = fe.Callbacks("once memory"), b = f.statusCode || {}, w = {}, x = {}, T = "canceled", E = {
                readyState: 0,
            ...
            if (g.promise(E),
            f.url = ((t || f.url || Et.href) + "").replace($t, Et.protocol + "//"),
            ...
            c)
                return E;
            (d = fe.event && f.global) && 0 == fe.active++ && fe.event.trigger("ajaxStart"),
            f.type = f.type.toUpperCase(),
            f.hasContent = !Nt.test(f.type),
            a = f.url.replace(Dt, ""),
            f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Pt, "+")) : (h = f.url.slice(a.length),
            f.data && (a += (St.test(a) ? "&" : "?") + f.data,
            delete f.data),
            !1 === f.cache && (a = a.replace(Ot, "$1"),
            h = (St.test(a) ? "&" : "?") + "_=" + Ct++ + h),
            f.url = a + h),
            f.ifModified && (fe.lastModified[a] && E.setRequestHeader("If-Modified-Since", fe.lastModified[a]),
            ...
            if (f.beforeSend && (!1 === f.beforeSend.call(v, E, f) || c))
                return E.abort();
            if (T = "abort",
            y.add(f.complete),
            E.done(f.success),
    ...
    pe.cors = !!Vt && "withCredentials"in Vt,
    pe.ajax = Vt = !!Vt,
    fe.ajaxTransport(function(t) {
        var n, i;
        if (pe.cors || Vt && !t.crossDomain)
            return {
                send: function(r, a) {
                    var s, o = t.xhr();
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? o.abort() : "error" === e ? "number" != typeof o.status ? a(0, "error") : a(o.status, o.statusText) : a(Bt[o.status] || o.status, o.statusText, "text" !== (o.responseType || "text") || "string" != typeof o.responseText ? {
                                binary: o.response
                            } : {
                                text: o.responseText
    ...
    fe.ajaxPrefilter("json jsonp", function(t, n, i) {
        ...
        if (o || "jsonp" === t.dataTypes[0])
            ...
            o ? t[o] = t[o].replace(_t, "$1" + r) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
            ...
            ,
            i.always(function() {
                void 0 === a ? fe(e).removeProp(r) : e[r] = a,
                t[r] && (t.jsonpCallback = n.jsonpCallback,
                Rt.push(r)),
                s && fe.isFunction(a) && a(s[0]),
                s = a = void 0
            }),
            "script"
    }),
    ...
    fe.parseHTML = function(e, t, n) {
        ...
        r = Ee.exec(e),
        a = !n && [],
        r ? [t.createElement(r[1])] : (r = w([e], t, a),
    ...
    fe.offset = {
        setOffset: function(e, t, n) {
            var i, r, a, s, o, l, u = fe.css(e, "position"), c = fe(e), d = {};
            "static" === u && (e.style.position = "relative"),
            o = c.offset(),
            a = fe.css(e, "top"),
            l = fe.css(e, "left"),
            ("absolute" === u || "fixed" === u) && (a + l).indexOf("auto") > -1 ? (i = c.position(),
            s = i.top,
            r = i.left) : (s = parseFloat(a) || 0,
            r = parseFloat(l) || 0),
            fe.isFunction(t) && (t = t.call(e, n, fe.extend({}, o))),
    ...
    fe.each({
        ...
        fe.fn[e] = function(i) {
            return Oe(this, function(e, i, r) {
                var a;
                return fe.isWindow(e) ? a = e : 9 === e.nodeType && (a = e.defaultView),
        ...
        fe.each({
            ...
            fe.fn[i] = function(r, a) {
                ...
                return Oe(this, function(t, n, r) {
                    var a;
                    return fe.isWindow(t) ? 0 === i.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (a = t.documentElement,
                    Math.max(t.body["scroll" + e], a["scroll" + e], t.body["offset" + e], a["offset" + e], a["client" + e])) : void 0 === r ? fe.css(t, n, o) : fe.style(t, n, r, o)
                }, t, s ? r : void 0, s)
            }
        })
    }),
...
function(e) {
    ...
    e.extend(e.easing, {
        ...
        easeInElastic: function(e, t, n, i, r) {
            ...
            var a = 0
              , s = i;
            return 0 == t ? n : 1 == (t /= r) ? n + i : (a || (a = .3 * r),
            s < Math.abs(i) ? (s = i,
            e = a / 4) : e = a / (2 * Math.PI) * Math.asin(i / s),
            -s * Math.pow(2, 10 * --t) * Math.sin(2 * (t * r - e) * Math.PI / a) + n)
        },
        easeOutElastic: function(e, t, n, i, r) {
            ...
            s < Math.abs(i) ? (s = i,
            e = a / 4) : e = a / (2 * Math.PI) * Math.asin(i / s),
            s * Math.pow(2, -10 * t) * Math.sin(2 * (t * r - e) * Math.PI / a) + i + n)
        },
        easeInOutElastic: function(e, t, n, i, r) {
            e = 1.70158;
            var a = 0
              , s = i;
            return 0 == t ? n : 2 == (t /= r / 2) ? n + i : (a || (a = .3 * r * 1.5),
            s < Math.abs(i) ? (s = i,
            e = a / 4) : e = a / (2 * Math.PI) * Math.asin(i / s),
            1 > t ? -.5 * s * Math.pow(2, 10 * --t) * Math.sin(2 * (t * r - e) * Math.PI / a) + n : s * Math.pow(2, -10 * --t) * Math.sin(2 * (t * r - e) * Math.PI / a) * .5 + i + n)
        },
        ...
        easeInOutBack: function(e, t, n, i, r, a) {
            return void 0 == a && (a = 1.70158),
            1 > (t /= r / 2) ? i / 2 * t * t * ((1 + (a *= 1.525)) * t - a) + n : i / 2 * ((t -= 2) * t * ((1 + (a *= 1.525)) * t + a) + 2) + n
        },
...
function(e) {
    ...
    e.html5Loader = function(t) {
        ...
        var E = function(t) {
          ...
          , S = function(e, t, n) {
            var i = n;
            "VIDEO" !== i.type && "AUDIO" !== i.type || (i = E(i)),
            i && (g += i.size,
            y[e].push(i))
        }
          , k = function(e) {
            var t;
            T("json loaded"),
            e.files[0].length || (e.files = [e.files]);
            for (var n = 0, i = e.files.length; n < i; n++) {
                y.push([]);
                for (var r = 0, a = (t = e.files[n]).length; r < a; r++)
                    S(n, 0, t[r])
            }
        }
          , M = function(t) {
            if (!i.cancelLoading) {
                var n, r = new e.Deferred, a = t.size, s = e("<img>");
                return "[object Object]" === t.source.toString() ? t.source.svg && x.svg ? n = t.source.svg : t.source.fallback && (n = t.source.fallback) : n = t.source,
                s.on("load", function() {
                    T("File Loaded:" + n),
                    m += a,
                    d(t, this),
            ...
            if (!i.cancelLoading) {
                ...
                a.on("loadedmetadata", function() {
                    a.on("progress", function() {
                        var e = 0;
                        T("loading in progress file:" + t.source),
                        this.buffered.length > 0 && (e = r / this.duration * this.buffered.end(0),
                        r -= e,
                        m += e,
                        C(),
                        1 / r * e > s && !o && l())
          ...
          , D = function() {
            ...
            e.each(t, function(e, t) {
                switch (T("preloading files"),
                T("file to preload:" + t.source),
                t.type) {
                case "IMAGE":
                    M(t);
                    break;
        ...
        return this.init = function() {
            ...
            var t = new e.Deferred
              , n = t.promise();
            u(),
            "object" == typeof r ? (e.proxy(k, this, r)(),
            t.resolve(r)) : (e.getJSON(r, t.resolve),
            t.pipe(e.proxy(k, this))),
            n.then(e.proxy(C, this)),
            n.then(e.proxy(D, this))
        }
        ,
...
function(e) {
    ...
    o.prototype = {
        utils: {
            ...
            replaceDiacritics: function(e) {
                for (var t = s.length; t--; )
                    e = e.toLowerCase().replace(s[t], a[t]);
                return e
            },
            format: function(e) {
                var t = arguments;
            ...
            triggerCallback: function(t, n) {
                ...
                e.isFunction(a) && a.apply(r, s),
                e(r).trigger(i + "-" + this.toDash(t), s)
            },
        ...
        init: function(t) {
            var n = this;
            if (n.options = e.extend(!0, {}, e.fn[i].defaults, n.options, t),
        ...
        setLabel: function() {
            ...
            if (t.state.multiple) {
                ...
                t.elements.label.html(r.join(t.options.multiple.separator))
            } else {
        ...
        populate: function() {
            ...
            r.length > 1 && t.state.multiple && (a = [],
            r.each(function() {
                a.push(e(this).index())
            })),
            t.state.currValue = ~a ? a : o,
            ...
            n.length && (n.each(function(n) {
                ...
                if (i.is("optgroup")) {
                    ...
                    i.children().each(function(n) {
                        var i = e(this);
                        r.items[n] = t.getItemData(s, i, r.groupDisabled),
                        t.lookupItems[s] = r.items[n],
                        s++
                    }),
                    t.items[n] = r
                } else
                    t.items[n] = t.getItemData(s, i, i.prop("disabled")),
        ...
        handleKeys: function(t) {
            var n = this
              ...
              , d = 0;
            if (13 !== i && 32 !== i || t.preventDefault(),
            a || s) {
                if (!n.options.allowWrap && c)
                    return;
                a && (d = n.utils.previousEnabledItem(n.items, u)),
                s && (d = n.utils.nextEnabledItem(n.items, u)),
                n.highlight(d)
            }
            return o && n.state.opened ? (n.select(u),
        ...
        open: function(n) {
            var a = this;
            return (!a.options.nativeOnMobile || !a.utils.isMobile()) && (a.utils.triggerCallback("BeforeOpen", a),
            n && (n.preventDefault(),
            n.stopPropagation()),
            void (a.state.enabled && (a.setOptionsDimensions(),
            e("." + a.classes.hideselect, "." + a.classes.open).children()[i]("close"),
            a.state.opened = !0,
            a.itemsHeight = a.elements.items.outerHeight(),
            a.itemsInnerHeight = a.elements.items.height(),
            a.elements.outerWrapper.addClass(a.classes.open),
            a.elements.input.val(""),
            n && "focusin" !== n.type && a.elements.input.focus(),
            setTimeout(function() {
                t.on("click" + r, e.proxy(a.close, a)).on("scroll" + r, e.proxy(a.isInViewport, a))
            }, 1),
            a.isInViewport(),
            a.options.preventWindowScroll && t.on("mousewheel.sl DOMMouseScroll" + r, "." + a.classes.scroll, function(t) {
                ...
                (i === this.scrollHeight - a.itemsInnerHeight && r < 0 || 0 === i && r > 0) && t.preventDefault()
            }),
            a.detectItemVisibility(a.state.selectedIdx),
            a.highlight(a.state.multiple ? -1 : a.state.selectedIdx),
            a.utils.triggerCallback("Open", a))))
        },
        close: function() {
            var e = this;
        ...
        select: function(t) {
            ...
            void 0 !== t && -1 !== t && !n.lookupItems[t].disabled) {
                if (n.state.multiple) {
                    ...
                    var r = e.inArray(t, n.state.selectedIdx);
                    -1 !== r ? n.state.selectedIdx.splice(r, 1) : n.state.selectedIdx.push(t),
                    i.removeClass("selected").filter(function(t) {
                        return -1 !== e.inArray(t, n.state.selectedIdx)
                    }).addClass("selected")
                } else
                    i.removeClass("selected").eq(n.state.selectedIdx = t).addClass("selected");
...
function(e, t, n, i) {
    ...
    function M(e, t) {
        ...
        r > 1 && !n.firstMultiple ? n.firstMultiple = P(t) : 1 === r && (n.firstMultiple = !1);
        var a = n.firstInput
          , s = n.firstMultiple
        ...
        t.scale = s ? H(s.pointers, i) : 1,
        t.rotation = s ? $(s.pointers, i) : 0,
        L(n, t);
        var u = e.element;
        v(t.srcEvent.target, u) && (u = t.srcEvent.target),
        t.target = u
    }
    function I(e, t) {
        var n = t.center
    ...
    function L(e, t) {
        var n, r, a, s, o = e.lastInterval || t, l = t.timeStamp - o.timeStamp;
    ...
    function B(e, t) {
        ...
        return t & (Ce | Se) && (n = w(n.concat(i), "identifier", !0)),
        [n, i]
    }
    function V() {
        this.evTarget = Ye,
    ...
    function R(e, t) {
        var n = b(e.touches)
          , i = this.targetIds;
        if (t & (Te | Ee) && 1 === n.length)
            return i[n[0].identifier] = !0,
            [n, n];
        var r, a, s = b(e.changedTouches), o = [], l = this.target;
        ...
        t === Te)
            for (r = 0; r < a.length; )
                ...
                r++;
        for (r = 0; r < s.length; )
            i[s[r].identifier] && o.push(s[r]),
            t & (Ce | Se) && delete i[s[r].identifier],
            r++;
    ...
    C.prototype = {
        ...
        init: function() {
            ...
            this.evWin && h(E(this.element), this.evWin, this.domHandler)
        },
        destroy: function() {
            this.evEl && f(this.element, this.evEl, this.domHandler),
            this.evTarget && f(this.target, this.evTarget, this.domHandler),
            this.evWin && f(E(this.element), this.evWin, this.domHandler)
        }
    };
    var $e = {
        mousedown: Te,
    ...
    u(j, C, {
        handler: function(e) {
            ...
            t & Ee && 1 !== e.which && (t = Ce),
            this.pressed && this.allow && (t & Ce && (this.pressed = !1),
    ...
    e.MSPointerEvent && (Be = "MSPointerDown",
    ...
    u(F, C, {
        handler: function(e) {
            ...
            r & Te && (0 === e.button || s) ? 0 > o && (t.push(e),
            o = t.length - 1) : r & (Ce | Se) && (n = !0),
            0 > o || (t[o] = e,
    ...
    u(q, C, {
        handler: function(e) {
            ...
            this.started) {
                ...
                t & (Ce | Se) && n[0].length - n[1].length == 0 && (this.started = !1),
                this.callback(this.manager, t, {
                    pointers: n[0],
                    changedPointers: n[1],
                    pointerType: be,
    ...
    W.prototype = {
        set: function(e) {
            e == Qe && (e = this.compute()),
            Ue && (this.manager.element.style[Ge] = e),
    ...
    Y.prototype = {
        ...
        dropRecognizeWith: function(e) {
            return a(e, "dropRecognizeWith", this) ? this : (e = Q(e, this),
        ...
        recognize: function(e) {
            var t = o({}, e);
            return d(this.options.enable, [this, t]) ? (this.state & (st | ot | 32) && (this.state = nt),
            this.state = this.process(t),
            void (this.state & (it | rt | at | ot) && this.tryEmit(t))) : (this.reset(),
            void (this.state = 32))
        },
        process: function() {},
    ...
    u(J, K, {
        ...
        directionTest: function(e) {
            var t = this.options
              ...
              , a = e.deltaX
              , s = e.deltaY;
            return r & t.direction || (t.direction & De ? (r = 0 === a ? ke : 0 > a ? Me : Ie,
            n = a != this.pX,
            i = Math.abs(e.deltaX)) : (r = 0 === s ? ke : 0 > s ? Le : Pe,
            n = s != this.pY,
            i = Math.abs(e.deltaY))),
            e.direction = r,
    ...
    u(ee, Y, {
        ...
        emit: function(e) {
            this.state === st && (e && e.eventType & Ce ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = he(),
    ...
    u(ne, K, {
        ...
        attrTest: function(e) {
            ...
            return n & (De | Oe) ? t = e.velocity : n & De ? t = e.velocityX : n & Oe && (t = e.velocityY),
            this._super.attrTest.call(this, e) && n & e.direction && e.distance > this.options.threshold && pe(t) > this.options.velocity && e.eventType & Ce
        },
        emit: function(e) {
            var t = U(e.direction);
            t && this.manager.emit(this.options.event + t, e),
        ...
        recognize: function(e) {
            ...
            if (!t.stopped) {
                ...
                for (var a = 0; a < i.length; )
                    ...
                    !r && n.state & (it | rt | at) && (r = t.curRecognizer = n),
                    a++
            }
        },
        get: function(e) {
...
var mediaQueriesHelper = function() {
    function e(e, t) {
        var n, i = e.cssRules ? e.cssRules : e.media, r = [], a = 0, s = i.length;
        for (a; a < s; a++)
            t(n = i[a]) && r.push(n);
        return r
    }
    ...
    function n(e) {
        ...
        return n.href = e,
        n.hostname === t.hostname && n.protocol === t.protocol
    }
    function i(e) {
    ...
    function a() {
        var e, t = document.styleSheets, n = t.length, a = 0, s = [];
        for (a; a < n; a++)
            (r(e = t[a]) || i(e)) && s.push(e);
        return s
    }
    function s(e) {
        var n, i, r = document.documentElement, s = window.innerWidth - r.clientWidth, o = {
            adjusted: s > 0,
        ...
        for (c; c < u; c++) {
            i = (n = t(l[c])).length;
            for (var d = 0; d < i; d++)
                n[d].media.mediaText = n[d].media.mediaText.replace(/m(in|ax)-width:\s*(\d|\.)+(px|em)/gi, function(e) {
                    if (e.match("px"))
                        return e.replace(/\d+px/gi, function(e) {
...
window.$clamp = function(e, t) {
    function n(e, t) {
        return u.getComputedStyle || (u.getComputedStyle = function(e, t) {
            ...
            this.getPropertyValue = function(t) {
                ...
                n.test(t) && (t = t.replace(n, function(e, t, n) {
    ...
    function r(e) {
        ...
        return "normal" == t && (t = 1.2 * parseInt(n(e, "font-size"))),
        parseInt(t)
    }
    function a(t) {
        return t.lastChild.children && 0 < t.lastChild.children.length ? a(Array.prototype.slice.call(t.children).pop()) : t.lastChild && t.lastChild.nodeValue && "" != t.lastChild.nodeValue && t.lastChild.nodeValue != c.truncationChar ? t.lastChild : (t.lastChild.parentNode.removeChild(t.lastChild),
        a(e))
    }
    function s(t, n) {
        if (n) {
            var i = t.nodeValue.replace(c.truncationChar, "");
            if (m || (b = 0 < y.length ? y.shift() : "",
            m = i.split(b)),
            1 < m.length ? (g = m.pop(),
            o(t, m.join(b))) : m = null,
            l && (t.nodeValue = t.nodeValue.replace(c.truncationChar, ""),
            e.innerHTML = t.nodeValue + " " + l.innerHTML + c.truncationChar),
            m) {
                if (e.clientHeight <= n) {
                    if (!(0 <= y.length && "" != b))
                        return e.innerHTML;
    ...
    }, d = e.style, p = e.innerHTML, h = void 0 !== e.style.webkitLineClamp, f = c.clamp, v = f.indexOf && (-1 < f.indexOf("px") || -1 < f.indexOf("em"));
    c.truncationHTML && (l = document.createElement("span"),
    l.innerHTML = c.truncationHTML);
    var m, g, y = c.splitOnChars.slice(0), b = y[0];
    "auto" == f ? f = i() : v && (f = i(parseInt(f)));
    var w;
    return h && c.useNativeClamp ? (d.overflow = "hidden",
    d.textOverflow = "ellipsis",
    d.webkitBoxOrient = "vertical",
    d.display = "-webkit-box",
    d.webkitLineClamp = f,
    v && (d.height = c.clamp + "px")) : (d = function(t) {
        return r(e) * t
...
function(e) {
    window.BNS = new function() {
        var e = {
          ...
          , t = ["iPad Simulator", "iPod Simulator", "iPad", "iPod"].includes(navigator.platform) || navigator.userAgent.includes("Mac") && "ontouchend"in document
          , n = function() {
            e.prevScroll = (window.pageYOffset || document.documentElement.scrollTop) - (document.documentElement.clientTop || 0),
            e.prevPosition = document.body.style.position,
            e.prevOverflow = document.body.style.overflow,
            e.prevClasses = document.body.className
        };
        return {
            set: function(t) {
                e.classes = t.classes
            ...
            on: function(i) {
                ...
                document.body.className = document.body.className + " " + e.classes + " " + i,
                t && (document.body.style.top = -e.prevScroll + "px",
                document.body.style.position = "fixed",
                document.body.style.overflow = "hidden"),
                bodyScrollLock.disableBodyScroll(document.querySelector("#nav"), {
            ...
            off: function() {
                if (t) {
                    if (!e.on)
                        return;
                    e.on = !1,
                    document.body.className = e.prevClasses,
                    document.body.style.top = 0,
                    document.body.style.position = e.prevPosition,
                    document.body.style.overflow = e.prevOverflow,
                    window.scrollTo(0, e.prevScroll)
                }
                document.body.className = e.prevClasses,
...
!function(e, t) {
    ...
    function t(e, t, n) {
        !n && w(e) || (k(t.callback_enter, e),
        A.indexOf(e.tagName) > -1 && (O(e, t),
        v(e, t.class_loading)),
        S(e, t),
        b(e),
        k(t.callback_set, e))
    ...
    return N.prototype = {
        _loopThroughElements: function(t) {
            ...
            0 !== r) {
                for (a = 0; a < r; a++) {
                    var l = i[a];
                    n.skip_invisible && null === l.offsetParent || (p || t || e(l, n.container, n.threshold)) && (o && v(l, n.class_initial),
                    this.load(l),
                    s.push(a))
                }
                z(i, s)
...
function(e, t) {
        ...
        if (e)
            if ("string" == typeof e) {
                ...
                if (s.indexOf("<") >= 0 && s.indexOf(">") >= 0) {
                    ...
                    (a = l.createElement(o)).innerHTML = s,
                    i = 0; i < a.childNodes.length; i += 1)
                        n.push(a.childNodes[i])
                } else
                    for (r = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || l).querySelectorAll(e.trim()) : [l.getElementById(e.trim().split("#")[1])],
                    i = 0; i < r.length; i += 1)
                        r[i] && n.push(r[i])
            } else if (e.nodeType || e === u || e === l)
                n.push(e);
    ...
    function n(t) {
        ...
        if (!n.animating || !r.preventInteractionOnTransition) {
            ...
            (i.isTouchEvent || !("which"in s) || 3 !== s.which) && !(!i.isTouchEvent && "button"in s && s.button > 0 || i.isTouched && i.isMoved))
                if (r.noSwiping && e(s.target).closest(r.noSwipingSelector ? r.noSwipingSelector : "." + r.noSwipingClass)[0])
                    n.allowClick = !0;
                    ...
                    if (!d || !(o <= h || o >= u.screen.width - h)) {
                        ...
                        "touchstart" !== s.type) {
                            var f = !0;
                            e(s.target).is(i.formElements) && (f = !1),
                            l.activeElement && e(l.activeElement).is(i.formElements) && l.activeElement !== s.target && l.activeElement.blur();
            ...
            if (!i.isTouchEvent || "mousemove" !== o.type) {
                ...
                if (i.isTouchEvent && r.touchReleaseOnEdges && !r.loop)
                    if (n.isVertical()) {
                        ...
                        return;
                if (i.isTouchEvent && l.activeElement && o.target === l.activeElement && e(o.target).is(i.formElements))
                    return i.isMoved = !0,
                    void (n.allowClick = !1);
                ...
                !(o.targetTouches && o.targetTouches.length > 1)) {
                    ...
                    if (!(n.params.threshold && Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2)) < n.params.threshold)) {
                        if (void 0 === i.isScrolling) {
                            var f;
                            n.isHorizontal() && a.currentY === a.startY || n.isVertical() && a.currentX === a.startX ? i.isScrolling = !1 : d * d + h * h >= 25 && (f = 180 * Math.atan2(Math.abs(h), Math.abs(d)) / Math.PI,
                            i.isScrolling = n.isHorizontal() ? f > r.touchAngle : 90 - f > r.touchAngle)
                        }
                        ...
                        i.isScrolling)
                            ...
                            r.resistance && (i.currentTranslate = n.minTranslate() - 1 + Math.pow(-n.minTranslate() + i.startTranslate + v, g))) : v < 0 && i.currentTranslate < n.maxTranslate() && (m = !1,
                            r.resistance && (i.currentTranslate = n.maxTranslate() + 1 - Math.pow(n.maxTranslate() - i.startTranslate - v, g))),
    ...
    function r(e) {
        ...
        n.clickTimeout = p.nextTick(function() {
            t && !t.destroyed && t.emit("click", u)
        }, 300)),
        d < 300 && c - n.lastClickTime < 300 && (n.clickTimeout && clearTimeout(n.clickTimeout),
        t.emit("doubleTap", u))),
        n.lastClickTime = p.now(),
        p.nextTick(function() {
        ...
        n.startMoving = !1;
        var h;
        if (h = i.followFinger ? a ? t.translate : -t.translate : -n.currentTranslate,
        i.freeMode) {
            if (h < -t.minTranslate())
            ...
            if (i.freeModeMomentum) {
                ...
                var y = 1e3 * i.freeModeMomentumRatio
                  ...
                  , w = t.translate + b;
                a && (w = -w);
                var x, T, E = !1, C = 20 * Math.abs(t.velocity) * i.freeModeMomentumBounceRatio;
                if (w < t.maxTranslate())
                ...
                i.freeModeMomentumBounce && E ? (t.updateProgress(x),
                t.setTransition(y),
                t.setTranslate(w),
            ...
            for (var M = 0, I = t.slidesSizesGrid[0], L = 0; L < o.length; L += i.slidesPerGroup)
                void 0 !== o[L + i.slidesPerGroup] ? h >= o[L] && h < o[L + i.slidesPerGroup] && (M = L,
                I = o[L + i.slidesPerGroup] - o[L]) : h >= o[L] && (M = L,
                I = o[o.length - 1] - o[o.length - 2]);
            var P = (h - o[M]) / I;
            if (d > i.longSwipesMs) {
                if (!i.longSwipes)
                    return void t.slideTo(t.activeIndex);
    ...
    var d = {
        ...
        on: function() {
            ...
            for (var i, r = [], a = arguments.length; a--; )
                r[a] = arguments[a];
            var s = r[0]
              , o = r[1]
              , l = r[2]
              , u = r[3];
            "function" == typeof r[1] && (s = (i = r)[0],
            l = i[1],
            u = i[2],
            o = void 0),
            u || (u = !1);
                ...
                for (var u = o[l], c = 0; c < this.length; c += 1) {
                    ...
                    p && p.length)
                        for (var h = p.length - 1; h >= 0; h -= 1) {
                            ...
                            p.splice(h, 1)) : a && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === a ? (d.removeEventListener(u, f.proxyListener, s),
                            p.splice(h, 1)) : a || (d.removeEventListener(u, f.proxyListener, s),
                            p.splice(h, 1))
                        }
                }
            return this
            ...
            for (var n = e[0].split(" "), i = e[1], r = 0; r < n.length; r += 1)
                for (var a = n[r], s = 0; s < this.length; s += 1) {
                    ...
                    try {
                        ...
                        (c = l.createEvent("Event")).initEvent(a, !0, !0),
                        c.detail = i
                    }
        ...
        eq: function(e) {
            if (void 0 === e)
                return this;
            var t, n = this.length;
            return e > n - 1 ? new c([]) : e < 0 ? (t = n + e,
            new c(t < 0 ? [] : [this[t]])) : new c([this[e]])
        },
        append: function() {
            for (var e = [], t = arguments.length; t--; )
                e[t] = arguments[t];
        ...
        parent: function(n) {
            for (var i = [], r = 0; r < this.length; r += 1)
                null !== this[r].parentNode && (n ? e(this[r].parentNode).is(n) && i.push(this[r].parentNode) : i.push(this[r].parentNode));
            return e(t(i))
        },
        parents: function(n) {
            for (var i = [], r = 0; r < this.length; r += 1)
                for (var a = this[r].parentNode; a; )
                    n ? e(a).is(n) && i.push(a) : i.push(a),
                    a = a.parentNode;
            return e(t(i))
        },
        closest: function(e) {
            var t = this;
            return void 0 === e ? new c([]) : (t.is(e) || (t = t.parents(e).eq(0)),
            t)
        },
        find: function(e) {
        ...
        children: function(n) {
            for (var i = [], r = 0; r < this.length; r += 1)
                for (var a = this[r].childNodes, s = 0; s < a.length; s += 1)
                    n ? 1 === a[s].nodeType && e(a[s]).is(n) && i.push(a[s]) : 1 === a[s].nodeType && i.push(a[s]);
            return new c(t(i))
        },
        remove: function() {
    ...
    var p = {
        ...
        getTranslate: function(e, t) {
            ...
            r = new u.WebKitCSSMatrix("none" === i ? "" : i)) : n = (r = a.MozTransform || a.OTransform || a.MsTransform || a.msTransform || a.transform || a.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")).toString().split(","),
            ...
            for (var n = Object(e[0]), i = 1; i < e.length; i += 1) {
                ...
                if (void 0 !== r && null !== r)
                    for (var a = Object.keys(Object(r)), s = 0, o = a.length; s < o; s += 1) {
                        ...
                        void 0 !== u && u.enumerable && (p.isObject(n[l]) && p.isObject(r[l]) ? p.extend(n[l], r[l]) : !p.isObject(n[l]) && p.isObject(r[l]) ? (n[l] = {},
                        p.extend(n[l], r[l])) : n[l] = r[l])
                    }
            }
            return n
        }
    ...
    v.prototype.once = function(e, t, n) {
        ...
        var r = this;
        return "function" != typeof t ? r : (i.f7proxy = t,
        r.on(e, i, n))
    }
    ,
    ...
    var g = {
        ...
        updateSlides: function() {
            ...
            if (void 0 !== i) {
                ...
                var C;
                t.slidesPerColumn > 1 && (C = Math.floor(c / t.slidesPerColumn) === c / e.params.slidesPerColumn ? c : Math.ceil(c / t.slidesPerColumn) * t.slidesPerColumn,
                ...
                for (var S, k = t.slidesPerColumn, M = C / k, I = Math.floor(c / t.slidesPerColumn), L = 0; L < c; L += 1) {
                    ...
                    if (t.slidesPerColumn > 1) {
                        var D = void 0
                          , O = void 0
                          , A = void 0;
                        "column" === t.slidesPerColumnFill ? (A = L - (O = Math.floor(L / k)) * k,
                        (O > I || O === I && A === k - 1) && (A += 1) >= k && (A = 0,
                        O += 1),
                        D = O + A * C / k,
                        P.css({
                            ...
                            "-webkit-order": D,
                            order: D
                        })) : O = L - (A = Math.floor(L / M)) * M,
                        P.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== A && t.spaceBetween && t.spaceBetween + "px").attr("data-swiper-column", O).attr("data-swiper-row", A)
                    }
                    if ("none" !== P.css("display")) {
                        if ("auto" === t.slidesPerView) {
                            ...
                            S = (i - (t.slidesPerView - 1) * w) / t.slidesPerView,
                            t.roundLengths && (S = Math.floor(S)),
                            l[L] && (e.isHorizontal() ? l[L].style.width = S + "px" : l[L].style.height = S + "px");
                        l[L] && (l[L].swiperSlideSize = S),
                        v.push(S),
                        t.centeredSlides ? (x = x + S / 2 + T / 2 + w,
                        0 === T && 0 !== L && (x = x - i / 2 - w),
                        0 === L && (x = x - i / 2 - w),
                        Math.abs(x) < .001 && (x = 0),
                        t.roundLengths && (x = Math.floor(x)),
                        E % t.slidesPerGroup == 0 && d.push(x),
                        f.push(x)) : (t.roundLengths && (x = Math.floor(x)),
                        E % t.slidesPerGroup == 0 && d.push(x),
                        f.push(x),
                        x = x + S + w),
                        e.virtualSize += S + w,
                ...
                t.slidesPerColumn > 1 && (e.virtualSize = (S + t.spaceBetween) * C,
                ...
                t.centeredSlides)) {
                    ...
                    for (var Q = 0; Q < d.length; Q += 1) {
                        ...
                        d[Q] < e.virtualSize + d[0] && U.push(K)
                    }
                    d = U
                }
                if (!t.centeredSlides) {
            ...
            if (0 !== r.length) {
                ...
                for (var o = 0; o < r.length; o += 1) {
                    ...
                    if (i.watchSlidesVisibility) {
                        ...
                        (c >= 0 && c < n.size || d > 0 && d <= n.size || c <= 0 && d >= n.size) && (n.visibleSlides.push(l),
        ...
        updateSlidesClasses: function() {
            ...
            var o;
            (o = s ? e.$wrapperEl.find("." + n.slideClass + '[data-swiper-slide-index="' + r + '"]') : t.eq(r)).addClass(n.slideActiveClass),
        ...
        updateActiveIndex: function(e) {
            var t, n = this, i = n.rtlTranslate ? n.translate : -n.translate, r = n.slidesGrid, a = n.snapGrid, s = n.params, o = n.activeIndex, l = n.realIndex, u = n.snapIndex, c = e;
            if (void 0 === c) {
                for (var d = 0; d < r.length; d += 1)
                    void 0 !== r[d + 1] ? i >= r[d] && i < r[d + 1] - (r[d + 1] - r[d]) / 2 ? c = d : i >= r[d] && i < r[d + 1] && (c = d + 1) : i >= r[d] && (c = d);
                s.normalizeSlideIndex && (c < 0 || void 0 === c) && (c = 0)
            }
            if ((t = a.indexOf(i) >= 0 ? a.indexOf(i) : Math.floor(c / s.slidesPerGroup)) >= a.length && (t = a.length - 1),
            c !== o) {
      ...
      , y = {
        ...
        setTranslate: function(e, t) {
            ...
            l = Math.floor(l)),
            r.virtualTranslate || (h.transforms3d ? a.transform("translate3d(" + o + "px, " + l + "px, 0px)") : a.transform("translate(" + o + "px, " + l + "px)")),
      ...
      , b = {
        ...
        transitionStart: function(e, t) {
            ...
            var s = t;
            if (s || (s = i > a ? "next" : i < a ? "prev" : "reset"),
      ...
      , w = {
        slideTo: function(e, t, n, i) {
            ...
            (c || s.initialSlide || 0) === (u || 0) && n && r.emit("beforeSlideChangeStart");
            var f = -o[p];
        ...
        slidePrev: function(e, t, n) {
            ...
            var c, d = i(u ? r.translate : -r.translate), p = o.map(function(e) {
                return i(e)
            }), h = (l.map(function(e) {
                return i(e)
            }),
            o[p.indexOf(d)],
            o[p.indexOf(d) - 1]);
            return void 0 !== h && (c = l.indexOf(h)) < 0 && (c = r.activeIndex - 1),
            r.slideTo(c, e, t, n)
        },
      ...
      , x = {
        loopCreate: function() {
            ...
            r.each(function(n, i) {
                ...
                n < r.length && n >= r.length - t.loopedSlides && u.push(i),
                a.attr("data-swiper-slide-index", n)
            });
            for (var d = 0; d < c.length; d += 1)
                i.append(e(c[d].cloneNode(!0)).addClass(n.slideDuplicateClass));
            for (var p = u.length - 1; p >= 0; p -= 1)
                i.prepend(e(u[p].cloneNode(!0)).addClass(n.slideDuplicateClass))
        },
        loopFix: function() {
            var e, t = this, n = t.params, i = t.activeIndex, r = t.slides, a = t.loopedSlides, s = t.allowSlidePrev, o = t.allowSlideNext, l = t.snapGrid, u = t.rtlTranslate;
            t.allowSlidePrev = !0,
            t.allowSlideNext = !0;
            var c = -l[i] - t.getTranslate();
            i < a ? (e = r.length - 3 * a + i,
            e += a,
            t.slideTo(e, 0, !1, !0) && 0 !== c && t.setTranslate((u ? -t.translate : t.translate) - c)) : ("auto" === n.slidesPerView && i >= 2 * a || i >= r.length - a) && (e = -r.length + i + a,
            e += a,
        ...
        addSlide: function(e, t) {
            ...
            if (e <= 0)
                ...
                for (var p = 0; p < l.length; p += 1)
                    i.append(l[p]);
                r.loop && n.loopCreate(),
                r.observer && h.observer || n.update(),
      ...
      , k = {
        ...
        events: {
            attachEvents: function() {
                ...
                if (h.touch || !h.pointerEvents && !h.prefixedPointerEvents) {
                    if (h.touch) {
                        ...
                        d.addEventListener(o.start, e.onTouchStart, f),
                        d.addEventListener(o.move, e.onTouchMove, h.passiveListener ? {
                            passive: !1,
                            capture: p
                        } : p),
                        d.addEventListener(o.end, e.onTouchEnd, f)
                    }
                    (t.simulateTouch && !C.ios && !C.android || t.simulateTouch && !h.touch && C.ios) && (d.addEventListener("mousedown", e.onTouchStart, !1),
                    l.addEventListener("mousemove", e.onTouchMove, p),
                    l.addEventListener("mouseup", e.onTouchEnd, !1))
                } else
                    d.addEventListener(o.start, e.onTouchStart, !1),
                    l.addEventListener(o.move, e.onTouchMove, p),
                    l.addEventListener(o.end, e.onTouchEnd, !1);
                (t.preventClicks || t.preventClicksPropagation) && d.addEventListener("click", e.onClick, !0),
                e.on(C.ios || C.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", a, !0)
            },
            detachEvents: function() {
                ...
                if (h.touch || !h.pointerEvents && !h.prefixedPointerEvents) {
                    ...
                    (t.simulateTouch && !C.ios && !C.android || t.simulateTouch && !h.touch && C.ios) && (s.removeEventListener("mousedown", e.onTouchStart, !1),
                    l.removeEventListener("mousemove", e.onTouchMove, o),
                    l.removeEventListener("mouseup", e.onTouchEnd, !1))
                } else
                    s.removeEventListener(n.start, e.onTouchStart, !1),
                    l.removeEventListener(n.move, e.onTouchMove, o),
                ...
                e.off(C.ios || C.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", a)
            }
        },
        breakpoints: {
        ...
        classes: {
            addClasses: function() {
                ...
                C.android && a.push("android"),
                C.ios && a.push("ios"),
                (f.isIE || f.isEdge) && (h.pointerEvents || h.prefixedPointerEvents) && a.push("wp8-" + n.direction),
        ...
        images: {
            loadImage: function(e, t, n, i, r, a) {
                ...
                var o;
                e.complete && r ? s() : t ? ((o = new u.Image).onload = s,
                o.onerror = s,
                i && (o.sizes = i),
                n && (o.srcset = n),
                t && (o.src = t)) : s()
      ...
      , I = function(t) {
        function n() {
            for (var i, r = [], a = arguments.length; a--; )
                r[a] = arguments[a];
            var s, o;
            1 === r.length && r[0].constructor && r[0].constructor === Object ? o = r[0] : (s = (i = r)[0],
            o = i[1]),
            o || (o = {}),
            o = p.extend({}, o),
            s && !o.el && (o.el = s),
            ...
            l.params = p.extend({}, u, M, o),
            l.originalParams = p.extend({}, l.params),
            l.passedParams = p.extend({}, o),
            l.$ = e;
            var c = e(l.params.el);
            if (s = c[0]) {
                if (c.length > 1) {
                ...
                return p.extend(l, {
                    ...
                    touchEvents: function() {
                        ...
                        return h.pointerEvents ? t = ["pointerdown", "pointermove", "pointerup"] : h.prefixedPointerEvents && (t = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
                        l.touchEventsTouch = {
                            start: e[0],
                            move: e[1],
                            end: e[2]
        ...
        return n.prototype.slidesPerViewDynamic = function() {
            var e = this
              ...
              , s = 1;
            if (t.centeredSlides) {
                for (var o, l = n[a].swiperSlideSize, u = a + 1; u < n.length; u += 1)
                    n[u] && !o && (s += 1,
                    (l += n[u].swiperSlideSize) > r && (o = !0));
        ...
        n.prototype.changeDirection = function(e, t) {
            ...
            e === i || "horizontal" !== e && "vertical" !== e ? n : ("vertical" === i && (n.$el.removeClass(n.params.containerModifierClass + "vertical wp8-vertical").addClass("" + n.params.containerModifierClass + e),
            (f.isIE || f.isEdge) && (h.pointerEvents || h.prefixedPointerEvents) && n.$el.addClass(n.params.containerModifierClass + "wp8-" + e)),
            "horizontal" === i && (n.$el.removeClass(n.params.containerModifierClass + "horizontal wp8-horizontal").addClass("" + n.params.containerModifierClass + e),
            (f.isIE || f.isEdge) && (h.pointerEvents || h.prefixedPointerEvents) && n.$el.addClass(n.params.containerModifierClass + "wp8-" + e)),
      ...
      , N = {
        update: function(e) {
            ...
            var w, x;
            s ? (w = Math.floor(r / 2) + a + l,
            x = Math.floor(r / 2) + a + u) : (w = r + (a - 1) + l,
            x = a + u);
            ...
            d === T && h === E && !e)
                return n.slidesGrid !== v && C !== g && n.slides.css(y, C + "px"),
            ...
            if (e)
                ...
                for (var M = d; M <= h; M += 1)
                    (M < T || M > E) && n.$wrapperEl.find("." + n.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
            for (var I = 0; I < f.length; I += 1)
                I >= T && I <= E && (void 0 === h || e ? k.push(I) : (I > h && k.push(I),
                I < d && S.push(I)));
            ...
            n.$wrapperEl.children(".swiper-slide").css(y, C + "px"),
            t()
        },
      ...
      , H = {
        handle: function(e) {
            ...
            if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (37 === r || 39 === r || 38 === r || 40 === r)) {
                    ...
                    for (var d = [[c.left, c.top], [c.left + t.width, c.top], [c.left, c.top + t.height], [c.left + t.width, c.top + t.height]], p = 0; p < d.length; p += 1) {
                        var h = d[p];
        ...
        enable: function() {
            var t = this;
            t.keyboard.enabled || (e(l).on("keydown", t.keyboard.handle),
            t.keyboard.enabled = !0)
        },
        disable: function() {
            var t = this;
            t.keyboard.enabled && (e(l).off("keydown", t.keyboard.handle),
      ...
      , F = {
        ...
        handle: function(e) {
            ...
            n.params.freeMode) {
                ...
                n.mousewheel.timeout = p.nextTick(function() {
                    n.slideToClosest()
                }, 300)),
                n.emit("scroll", t),
        ...
        enable: function() {
            ...
            n.on(F.event, t.mousewheel.handle),
        ...
        disable: function() {
            ...
            var n = t.$el;
            return "container" !== t.params.mousewheel.eventsTarged && (n = e(t.params.mousewheel.eventsTarged)),
            n.off(F.event, t.mousewheel.handle),
      ...
      , B = {
        update: function() {
            ...
            if (i.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                ...
                if (t.params.loop ? ((r = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > a - 1 - 2 * t.loopedSlides && (r -= a - 2 * t.loopedSlides),
                r > o - 1 && (r -= o),
                ...
                "bullets" === i.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                    ...
                    if (i.dynamicBullets && (t.pagination.bulletSize = d.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    s.css(t.isHorizontal() ? "width" : "height", t.pagination.bulletSize * (i.dynamicMainBullets + 4) + "px"),
                    i.dynamicMainBullets > 1 && void 0 !== t.previousIndex && (t.pagination.dynamicBulletIndex += r - t.previousIndex,
                    t.pagination.dynamicBulletIndex > i.dynamicMainBullets - 1 ? t.pagination.dynamicBulletIndex = i.dynamicMainBullets - 1 : t.pagination.dynamicBulletIndex < 0 && (t.pagination.dynamicBulletIndex = 0)),
                    l = r - t.pagination.dynamicBulletIndex,
                    c = ((u = l + (Math.min(d.length, i.dynamicMainBullets) - 1)) + l) / 2),
                    ...
                    s.length > 1)
                        d.each(function(t, n) {
                            ...
                            i.dynamicBullets && (s >= l && s <= u && a.addClass(i.bulletActiveClass + "-main"),
                            s === l && a.prev().addClass(i.bulletActiveClass + "-prev").prev().addClass(i.bulletActiveClass + "-prev-prev"),
                            s === u && a.next().addClass(i.bulletActiveClass + "-next").next().addClass(i.bulletActiveClass + "-next-next"))
                        });
                    else if (d.eq(r).addClass(i.bulletActiveClass),
                    i.dynamicBullets) {
                        for (var p = d.eq(l), h = d.eq(u), f = l; f <= u; f += 1)
                ...
                "progressbar" === i.type) {
                    ...
                    s.find("." + i.progressbarFillClass).transform("translate3d(0,0,0) scaleX(" + w + ") scaleY(" + x + ")").transition(t.params.speed)
                }
      ...
      , V = {
        setTranslate: function() {
            ...
            if (e.params.scrollbar.el && e.scrollbar.el) {
                var t = e.scrollbar
                  ...
                  , c = (a - r) * i;
                n ? (c = -c) > 0 ? (u = r - c,
                c = 0) : -c + r > a && (u = a + c) : c < 0 ? (u = r + c,
                c = 0) : c + r > a && (u = a - c),
                e.isHorizontal() ? (h.transforms3d ? s.transform("translate3d(" + c + "px, 0, 0)") : s.transform("translateX(" + c + "px)"),
                s[0].style.width = u + "px") : (h.transforms3d ? s.transform("translate3d(0px, " + c + "px, 0)") : s.transform("translateY(" + c + "px)"),
        ...
        setDragPosition: function(e) {
            var t, n = this, i = n.scrollbar, r = n.rtlTranslate, a = i.$el, s = i.dragSize, o = i.trackSize;
            t = ((n.isHorizontal() ? "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX || e.clientX : "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY || e.clientY) - a.offset()[n.isHorizontal() ? "left" : "top"] - s / 2) / (o - s),
        ...
        enableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                h.touch ? (a.addEventListener(n.start, e.scrollbar.onDragStart, s),
                a.addEventListener(n.move, e.scrollbar.onDragMove, s),
                a.addEventListener(n.end, e.scrollbar.onDragEnd, o)) : (a.addEventListener(i.start, e.scrollbar.onDragStart, s),
                l.addEventListener(i.move, e.scrollbar.onDragMove, s),
                l.addEventListener(i.end, e.scrollbar.onDragEnd, o))
            }
        },
        disableDraggable: function() {
            ...
            if (e.params.scrollbar.el) {
                ...
                h.touch ? (a.removeEventListener(n.start, e.scrollbar.onDragStart, s),
                a.removeEventListener(n.move, e.scrollbar.onDragMove, s),
                a.removeEventListener(n.end, e.scrollbar.onDragEnd, o)) : (a.removeEventListener(i.start, e.scrollbar.onDragStart, s),
                l.removeEventListener(i.move, e.scrollbar.onDragMove, s),
                l.removeEventListener(i.end, e.scrollbar.onDragEnd, o))
            }
        },
        init: function() {
            var t = this;
            if (t.params.scrollbar.el) {
                ...
                0 === s.length && (s = e('<div class="' + t.params.scrollbar.dragClass + '"></div>'),
                a.append(s)),
                p.extend(n, {
                    $el: a,
                    el: a[0],
      ...
      , _ = {
        ...
        onGestureStart: function(t) {
            ...
            !h.gestures) {
                ...
                a.scaleStart = _.getDistanceBetweenTouches(t)
            }
            a.$slideEl && a.$slideEl.length || (a.$slideEl = e(t.target).closest(".swiper-slide"),
            ...
            n.zoom.isScaling = !0) : a.$imageEl = void 0
        },
        onGestureChange: function(e) {
            ...
            r.$imageEl && 0 !== r.$imageEl.length && (h.gestures ? i.scale = e.scale * i.currentScale : i.scale = r.scaleMove / r.scaleStart * i.currentScale,
        ...
        onTouchStart: function(e) {
            var t = this.zoom
              , n = t.gesture
              , i = t.image;
            n.$imageEl && 0 !== n.$imageEl.length && (i.isTouched || (C.android && e.preventDefault(),
            i.isTouched = !0,
        ...
        onTouchMove: function(e) {
            ...
            r.isTouched && i.$slideEl)) {
                ...
                r.startX = p.getTranslate(i.$imageWrapEl[0], "x") || 0,
                r.startY = p.getTranslate(i.$imageWrapEl[0], "y") || 0,
        ...
        in: function(t) {
            ...
            a.$imageEl && 0 !== a.$imageEl.length) {
                ...
                t ? (x = a.$slideEl[0].offsetWidth,
                T = a.$slideEl[0].offsetHeight,
                u = a.$slideEl.offset().left + x / 2 - o,
                c = a.$slideEl.offset().top + T / 2 - l,
                h = a.$imageEl[0].offsetWidth,
                f = a.$imageEl[0].offsetHeight,
                v = h * i.scale,
                m = f * i.scale,
                b = -(g = Math.min(x / 2 - v / 2, 0)),
                w = -(y = Math.min(T / 2 - m / 2, 0)),
                d = u * i.scale,
                p = c * i.scale,
                d < g && (d = g),
                d > b && (d = b),
                ...
                p > w && (p = w)) : (d = 0,
                p = 0),
                a.$imageWrapEl.transition(300).transform("translate3d(" + d + "px, " + p + "px,0)"),
        ...
        enable: function() {
            ...
            if (!t.enabled) {
                ...
                h.gestures ? (e.$wrapperEl.on("gesturestart", ".swiper-slide", t.onGestureStart, n),
        ...
        disable: function() {
            ...
            if (t.enabled) {
                ...
                h.gestures ? (e.$wrapperEl.off("gesturestart", ".swiper-slide", t.onGestureStart, n),
      ...
      , W = {
        ...
        load: function() {
            ...
            i.params.watchSlidesVisibility)
                ...
                for (var d = o; d < o + c; d += 1)
                    t(d) && i.lazy.loadInSlide(d);
            else
                i.lazy.loadInSlide(o);
            if (u.loadPrevNext)
                if (c > 1 || u.loadPrevNextAmount && u.loadPrevNextAmount > 1) {
                    for (var p = u.loadPrevNextAmount, h = c, f = Math.min(o + h + Math.max(p, h), s.length), v = Math.max(o - Math.max(h, p), 0), m = o + c; m < f; m += 1)
        ...
        setTranslate: function(e, t) {
            ...
            if (Array.isArray(s))
                for (var o = 0; o < s.length; o += 1)
                    s[o] !== t && s[o]instanceof I && n(s[o]);
            else
                s instanceof I && t !== s && n(s)
        },
        setTransition: function(e, t) {
            function n(t) {
                t.setTransition(e, r),
                0 !== e && (t.transitionStart(),
                t.params.autoHeight && p.nextTick(function() {
                    t.updateAutoHeight()
                }),
            ...
            if (Array.isArray(a))
                for (i = 0; i < a.length; i += 1)
                    a[i] !== t && a[i]instanceof I && n(a[i]);
            else
                a instanceof I && t !== a && n(a)
        }
    }
      , Y = {
      ...
      , G = {
        ...
        setHistoryPopState: function() {
            var e = this;
            e.history.paths = G.getPathValues(),
      ...
      , J = {
        setTranslate: function() {
            var t, n = this, i = n.$el, r = n.$wrapperEl, a = n.slides, s = n.width, o = n.height, l = n.rtlTranslate, u = n.size, c = n.params.cubeEffect, d = n.isHorizontal(), p = n.virtual && n.params.virtual.enabled, h = 0;
            c.shadow && (d ? (0 === (t = r.find(".swiper-cube-shadow")).length && (t = e('<div class="swiper-cube-shadow"></div>'),
            r.append(t)),
            t.css({
                height: s + "px"
            ...
            for (var v = 0; v < a.length; v += 1) {
                ...
                c.slideShadows) {
                    ...
                    0 === S.length && (S = e('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>'),
                    m.append(S)),
            ...
            c.shadow)
                if (d)
                    t.transform("translate3d(0px, " + (s / 2 + c.shadowOffset) + "px, " + -s / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + c.shadowScale + ")");
                else {
        ...
        setTranslate: function() {
            for (var t = this, n = t.slides, i = t.rtlTranslate, r = 0; r < n.length; r += 1) {
                ...
                var o = -180 * s
                  ...
                  , c = 0;
                if (t.isHorizontal() ? i && (o = -o) : (c = u,
                u = 0,
                l = -o,
                o = 0),
                a[0].style.zIndex = -Math.abs(Math.round(s)) + n.length,
                t.params.flipEffect.slideShadows) {
                    ...
                    a.append(d)),
                    0 === p.length && (p = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right" : "bottom") + '"></div>'),
                    a.append(p)),
      ...
      , ee = {
        setTranslate: function() {
            for (var t = this, n = t.width, i = t.height, r = t.slides, a = t.$wrapperEl, s = t.slidesSizesGrid, o = t.params.coverflowEffect, l = t.isHorizontal(), u = t.translate, c = l ? n / 2 - u : i / 2 - u, d = l ? o.rotate : -o.rotate, p = o.depth, f = 0, v = r.length; f < v; f += 1) {
                ...
                if (m.transform(C),
                m[0].style.zIndex = 1 - Math.abs(Math.round(y)),
                o.slideShadows) {
        ...
        onThumbClick: function() {
            ...
            if (n) {
                ...
                if (!(r && e(r).hasClass(t.params.thumbs.slideThumbActiveClass) || void 0 === i || null === i)) {
                    var a;
                    if (a = n.params.loop ? parseInt(e(n.clickedSlide).attr("data-swiper-slide-index"), 10) : i,
                    t.params.loop) {
                        var s = t.activeIndex;
                        t.slides.eq(s).hasClass(t.params.slideDuplicateClass) && (t.loopFix(),
        ...
        update: function(e) {
            ...
            if (n) {
                ...
                if (t.realIndex !== n.realIndex) {
                    ...
                    if (n.params.loop) {
                        n.slides.eq(a).hasClass(n.params.slideDuplicateClass) && (n.loopFix(),
                        ...
                        r = t.realIndex;
                    n.visibleSlidesIndexes.indexOf(r) < 0 && (n.params.centeredSlides ? r = r > a ? r - Math.floor(i / 2) + 1 : r + Math.floor(i / 2) - 1 : r > a && (r = r - i + 1),
      ...
      , ne = [L, P, D, O, z, $, j, {
        ...
        on: {
            ...
            click: function(t) {
                var n = this;
                n.params.pagination.el && n.params.pagination.hideOnClick && n.pagination.$el.length > 0 && !e(t.target).hasClass(n.params.pagination.bulletClass) && (!0 === n.pagination.$el.hasClass(n.params.pagination.hiddenClass) ? n.emit("paginationShow", n) : n.emit("paginationHide", n),
    ...
    , function(e, t, n) {
        ...
        var f = !!p && {
          ...
          , v = function() {
            function e(t, n) {
                function o() {
                    if (u.viewportTop = s(t),
                    u.viewportBottom = u.viewportTop + u.viewportHeight,
                    u.documentHeight = a(t),
                    u.documentHeight !== d) {
                        for (p = u.watchers.length; p--; )
                            u.watchers[p].recalculateLocation();
                        d = u.documentHeight
                    }
                }
                function l() {
                    for (h = u.watchers.length; h--; )
                        u.watchers[h].update();
                    for (h = u.watchers.length; h--; )
                        u.watchers[h].triggerCallbacks()
                }
                i(this, e);
                var u = this;
                this.item = t,
                ...
                this.documentHeight = a(t),
                this.viewportHeight = r(t),
            ...
            return e.prototype.listenToDOM = function() {
                u && (window.addEventListener ? (this.item === document.body ? window.addEventListener("scroll", this.DOMListener, f) : this.item.addEventListener("scroll", this.DOMListener, f),
                ...
                this.destroy = function() {
                    window.addEventListener ? (this.item === document.body ? (window.removeEventListener("scroll", this.DOMListener, f),
                    this.containerWatcher.destroy()) : this.item.removeEventListener("scroll", this.DOMListener, f),
            ...
            e.prototype.setState = function(e, t, n, i) {
                ...
                if (this.latestEvent = i,
                this.viewportTop = e,
                this.viewportHeight = t,
                this.viewportBottom = e + t,
                this.contentHeight = n,
                r)
                    for (var a = this.watchers.length; a--; )
                        this.watchers[a].recalculateLocation();
    ...
    , function(e, t, n) {
        ...
        function i(e, t, n) {
            function i(e, t) {
                if (0 !== e.length)
                    for (w = e.length; w--; )
                        (x = e[w]).callback.call(r, t, r),
                        x.isOne && e.splice(w, 1)
            }
            var r = this;
            this.watchItem = t,
            this.container = e,
            ...
            this.triggerCallbacks = function(e) {
                switch (this.isInViewport && !m && i(this.callbacks[s], e),
                this.isFullyInViewport && !g && i(this.callbacks[o], e),
                this.isAboveViewport !== y && this.isBelowViewport !== b && (i(this.callbacks[a], e),
                g || this.isFullyInViewport || (i(this.callbacks[o], e),
                i(this.callbacks[u], e)),
                m || this.isInViewport || (i(this.callbacks[s], e),
                i(this.callbacks[l], e))),
                !this.isFullyInViewport && g && i(this.callbacks[u], e),
                !this.isInViewport && m && i(this.callbacks[l], e),
                this.isInViewport !== m && i(this.callbacks[a], e),
                !0) {
            ...
            this.recalculateLocation = function() {
                if (!this.locked) {
                    ...
                    if (this.watchItem.nodeName) {
                        ...
                        for (var r = 0, a = this.container; a.containerWatcher; )
                            r += a.containerWatcher.top - a.containerWatcher.container.viewportTop,
                            a = a.containerWatcher.container;
                        var s = this.watchItem.getBoundingClientRect();
                        this.top = s.top + this.container.viewportTop - r,
                        this.bottom = s.bottom + this.container.viewportTop - r,
                    ...
                    void 0 === e && void 0 === t || this.top === e && this.bottom === t || i(this.callbacks[c], null)
                }
            }
            ,
        ...
        i.prototype = {
            on: function(e, t, n) {
                ...
                case e === u && this.isInViewport && this.isAboveViewport:
                    if (t.call(this, this.container.latestEvent, this),
                    n)
                        return
                }
                if (!this.callbacks[e])
            ...
            off: function(e, t) {
                if (!this.callbacks[e])
                    throw new Error("Tried to remove a scroll monitor listener of type " + e + ". Your options are: " + p.join(", "));
...
function(e, t) {
    ...
    var r = ["iPad Simulator", "iPod Simulator", "iPad", "iPod"].includes(navigator.platform) || navigator.userAgent.includes("Mac") && "ontouchend"in document
      , a = null
      , s = []
      , o = !1
      , l = -1
      ...
      , g = function(e, t) {
        ...
        return t && 0 === t.scrollTop && n > 0 ? h(e) : m(t) && n < 0 ? h(e) : (e.stopPropagation(),
        !0)
    };
    e.disableBodyScroll = function(e, i) {
        r ? e && !s.includes(e) && (s = [].concat(t(s), [e]),
